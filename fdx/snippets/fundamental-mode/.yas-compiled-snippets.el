...
(yas-define-snippets 'fundamental-mode
                     '(("shebang" "#!${1:$$(yas/choose-value '(\"/usr/bin/env ruby\" \"/bin/bash\" \"/bin/sh\"))}$0" "Shebang Line" nil nil nil "/home/fedex/.emacs.d/fdx/snippets/fundamental-mode/shebang.yasnippet" nil nil)
