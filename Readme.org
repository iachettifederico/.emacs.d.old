...
*** Add a before hook to fix =C-e= on multiple lines

If I don't add this, whenever I have a line that visually extends onto two or three lines, going to the beginning or end of the line goes to the beginning or end of the visual line instead of the actual line, which is annoying
