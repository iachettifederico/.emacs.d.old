;;; whitespace-cleanup-mode-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(let ((loads (get 'whitespace-cleanup 'custom-loads))) (if (member '"whitespace-cleanup-mode" loads) nil (put 'whitespace-cleanup 'custom-loads (cons '"whitespace-cleanup-mode" loads)) (put 'convenience 'custom-loads (cons 'whitespace-cleanup (get 'convenience 'custom-loads)))))
